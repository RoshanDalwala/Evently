...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:37:12 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/bower_components/owl.carousel/css/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/bower_components/owl.carousel/css/owl.theme.default.css">

<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/bower_components/swiper/css/swiper.min.css">
...
<img class="d-block img-fluid w-100" src="<?=base_url('resources/admin/')?>/assets/images/slider/slide1.jpg" alt="First slide">
</div>
<div class="carousel-item">
<img class="d-block img-fluid w-100" src="<?=base_url('resources/admin/')?>/assets/images/slider/slide2.jpg" alt="Second slide">
</div>
<div class="carousel-item">
<img class="d-block img-fluid w-100" src="<?=base_url('resources/admin/')?>/assets/images/slider/slide3.jpg" alt="Third slide">
</div>
 <div class="carousel-item">
<img class="d-block img-fluid w-100" src="<?=base_url('resources/admin/')?>/assets/images/slider/slide4.jpg" alt="Third slide">
</div>
</div>
...
<div>
<img class="d-block img-fluid" src="<?=base_url('resources/admin/')?>/assets/images/slider/slider5.jpg" alt="Third slide">
</div>
<div>
<img class="d-block img-fluid" src="<?=base_url('resources/admin/')?>/assets/images/slider/slider6.jpg" alt="Third slide">
</div>
<div>
<img class="d-block img-fluid" src="<?=base_url('resources/admin/')?>/assets/images/slider/slider7.jpg" alt="Third slide">
</div>
</div>
</div>
</div>
...
<img class="img-fluid width-100" src="<?=base_url('resources/admin/')?>/assets/images/task/task-u2.jpg" alt="Card image cap">


</div>

<div class="swiper-slide">
<img class="img-fluid width-100" src="<?=base_url('resources/admin/')?>/assets/images/task/task-u3.jpg" alt="Card image cap">


</div>

<div class="swiper-slide">
<img class="img-fluid width-100" src="<?=base_url('resources/admin/')?>/assets/images/task/task-u4.jpg" alt="Card image cap">


</div>

<div class="swiper-slide">
<img class="img-fluid width-100" src="<?=base_url('resources/admin/')?>/assets/images/task/task-u1.jpg" alt="Card image cap">
...
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/bower_components/owl.carousel/js/owl.carousel.min.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/js/owl-custom.js"></script>

<script type="text/javascript" src="<?=base_url('resources/admin/')?>/bower_components/swiper/js/swiper.min.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/js/swiper-custom.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:37:18 GMT -->
</html>
