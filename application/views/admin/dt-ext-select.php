...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-ext-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:38:55 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/select/css/select.dataTables.min.css">
<script src="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/select/js/select-custom.js"></script>
...
<script src="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/select/js/dataTables.select.min.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-ext-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:38:58 GMT -->
</html>
