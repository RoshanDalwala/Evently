...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-ext-basic-buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:38:24 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/buttons/css/buttons.dataTables.min.css">
...
<script src="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/buttons/js/dataTables.buttons.min.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/buttons/js/buttons.flash.min.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/buttons/js/jszip.min.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/buttons/js/pdfmake.min.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/buttons/js/vfs_fonts.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/buttons/js/buttons.colVis.min.js"></script>
...
<script src="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/buttons/js/extension-btns-custom.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-ext-basic-buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:38:33 GMT -->
</html>
