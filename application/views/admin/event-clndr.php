...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/event-clndr.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:40:04 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/pages/flag-icon/flag-icon.min.css">
...
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/pages/clndr-calendar/css/clndr.css">
...
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/bower_components/moment/js/moment.min.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/bower_components/underscore/js/underscore-min.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/bower_components/clndr/js/clndr.js"></script>

<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/pages/prism/custom-prism.js"></script>

<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/pages/clndr-calendar/js/clndr-custom.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/event-clndr.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:40:06 GMT -->
</html>
