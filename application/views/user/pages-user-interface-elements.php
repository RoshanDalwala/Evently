						...
						<li><a href="#">Mega Menu</a>
							<div class="mega-menu mobile-styles three-columns">
									...
									<div class="mega-menu-section">
										<ul>
											<li class="mega-menu-headline">Headline #1</li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i>Item #1</a></li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i>Item #2</a></li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i>Item #3</a></li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i>Item #4</a></li>
										</ul>
									</div>

									<div class="mega-menu-section">
										<ul>
											<li class="mega-menu-headline">Headline #2</li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i>Item #1</a></li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i>Item #2</a></li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i>Item #3</a></li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i>Item #4</a></li>
									...
									<div class="mega-menu-section">
										<ul>
											<li class="mega-menu-headline">Headline #3</li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i>Item #1</a></li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i>Item #2</a></li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i>Item #3</a></li>
											<li><a href="pages-user-profile.html"><i class="sl sl-icon-user"></i>Item #4</a></li>
