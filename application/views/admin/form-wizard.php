...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:38:12 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url("resources/admin/")?>/bower_components/jquery.steps/css/jquery.steps.css">
...
<script src="<?=base_url("resources/admin/")?>/bower_components/jquery.cookie/js/jquery.cookie.js"></script>
<script src="<?=base_url("resources/admin/")?>/bower_components/jquery.steps/js/jquery.steps.js"></script>
<script src="<?=base_url("resources/admin/")?>/bower_components/jquery-validation/js/jquery.validate.js"></script>

<script src="./././cdnjs.cloudflare.com/ajax/libs/underscore.js/1.8.3/underscore-min.js"></script>
<script src="./././cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.6/moment.min.js"></script>
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/assets/pages/form-validation/validate.js"></script>

<script src="<?=base_url("resources/admin/")?>/assets/pages/forms-wizard-validation/form-wizard.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:38:13 GMT -->
</html>
