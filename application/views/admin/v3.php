                                                                ...
                                                                <div class="container">
                                                                    <div class="row ">
                                                                        <div class="col-lg-4 offset-lg-3 col-md-12">
                                                                            <form method="post" action="<?=site_url("Welcome/v3")?>">
                                                                                    <div class="form">
                                                                                          ...
                                                                                          <div class="form-group">
                                                                                                <label>Enter Students Roll Number</label>
                                                                                                <input type="text" class="form-control" name="txtRoll">
                                                                                          </div>

                                                                                          <div class="form-group">
                                                                                                <label>Enter Students Study</label>
                                                                                                <input type="text" class="form-control" name="txtStd">
                                                                                          </div>

                                                                                          <div class="form-group">
                                                                                                <label>Enter Students Subject</label>
                                                                                                <input type="text" class="form-control" name="txtSub">
                                                                                          </div>

                                                                                          <div>
                                                                                            <label>Enter Students Marks</label>
