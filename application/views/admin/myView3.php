                                                        ...
                                                        <div class="col-sm-12">
                                                                ...
                                                                <div class="container">
                                                                    <div class="row ">
                                                                        ...
                                                                        <div class="col-lg-3 col-md-12">
                                                                            <button type="button" class="btn btn-primary btn-md waves-effect waves-light butt js--triggerAnimation">Animate This Image!</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                            <table border="2" bgcolor="#ADE7C3" class="table table-striped" style="font-family: monospace; text-align: center;">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Roll Number</th>
                                                                        <th>Name</th>
                                                            ...
                                                            <div id="animationSandbox">
                                                                <div class="text-center animation-image">
                                                                    <img class="d-block img-fluid img-thumbnail" src="<?=base_url('resources/admin/')?>/assets/images/logo.jpg" alt="Third slide">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
