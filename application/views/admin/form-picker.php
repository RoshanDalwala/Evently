...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-picker.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:37:56 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url("resources/admin/")?>/assets/pages/advance-elements/css/bootstrap-datetimepicker.css">

<link rel="stylesheet" type="text/css" href="<?=base_url("resources/admin/")?>/bower_components/bootstrap-daterangepicker/css/daterangepicker.css" />

<link rel="stylesheet" type="text/css" href="<?=base_url("resources/admin/")?>/bower_components/datedropper/css/datedropper.min.css" />

<link rel="stylesheet" type="text/css" href="<?=base_url("resources/admin/")?>/bower_components/spectrum/css/spectrum.css" />

<link rel="stylesheet" type="text/css" href="<?=base_url("resources/admin/")?>/bower_components/jquery-minicolors/css/jquery.minicolors.css" />
...
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/assets/pages/advance-elements/moment-with-locales.min.js"></script>
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/bower_components/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/assets/pages/advance-elements/bootstrap-datetimepicker.min.js"></script>

<script type="text/javascript" src="<?=base_url("resources/admin/")?>/bower_components/bootstrap-daterangepicker/js/daterangepicker.js"></script>

<script type="text/javascript" src="<?=base_url("resources/admin/")?>/bower_components/datedropper/js/datedropper.min.js"></script>

<script type="text/javascript" src="<?=base_url("resources/admin/")?>/bower_components/spectrum/js/spectrum.js"></script>
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/bower_components/jscolor/js/jscolor.js"></script>

<script type="text/javascript" src="<?=base_url("resources/admin/")?>/bower_components/jquery-minicolors/js/jquery.minicolors.min.js"></script>

<script type="text/javascript" src="<?=base_url("resources/admin/")?>/assets/pages/advance-elements/custom-picker.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-picker.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:38:07 GMT -->
</html>
