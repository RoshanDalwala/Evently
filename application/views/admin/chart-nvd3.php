...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/chart-nvd3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:39:29 GMT -->
<head>
...
<link rel="stylesheet" href="<?=base_url('resources/admin/')?>/bower_components/nvd3/css/nv.d3.css" type="text/css" media="all">
...
<script src="<?=base_url('resources/admin/')?>/bower_components/d3/js/d3.js"></script>
<script src="<?=base_url('resources/admin/')?>/bower_components/nvd3/js/nv.d3.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/chart/nv-chart/js/stream_layers.js"></script>

<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/pages/chart/nvd3/chart-nvd3.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/chart-nvd3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:39:32 GMT -->
</html>
