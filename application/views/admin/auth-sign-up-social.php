...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/auth-sign-up-social.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:39:51 GMT -->
<head>
...
<link rel="stylesheet" href="<?=base_url('resources/admin/')?>/assets/pages/waves/css/waves.min.css" type="text/css" media="all"> <link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/icon/feather/css/feather.css">
...
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/css/style.css"><link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/css/pages.css">
</head>
...
<img src="<?=base_url('resources/admin/')?>/assets/images/logo.png" alt="logo.png">
</div>
...
<div class="col-md-2">
<img src="<?=base_url('resources/admin/')?>/assets/images/auth/Logo-small-bottom.png" alt="small-logo.png">
</div>
</div>
</div>
</div>
...
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/bower_components/i18next/js/i18next.min.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/bower_components/i18next-xhr-backend/js/i18nextXHRBackend.min.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/bower_components/i18next-browser-languagedetector/js/i18nextBrowserLanguageDetector.min.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/bower_components/jquery-i18next/js/jquery-i18next.min.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/js/common-pages.js"></script>
</body>

<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/auth-sign-up-social.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:39:52 GMT -->
</html>
