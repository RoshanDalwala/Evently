...
<html lang="en">
      ...
      <head>
            <title>Evently</title>
                  <?php include_once("topScripts2.php")?>
      </head>
      <body>
                                                      ...
                                                      <li class="user-profile header-notification">
                                                            <div class="dropdown-primary dropdown">
                                                                  <div class="dropdown-toggle" data-toggle="dropdown">
                                                                        ...
                                                                        <span style="font-family: fantasy;">Roshan Dalwala</span>
...
<div class="pcoded-content">
                                    ...
                                    <div class="col-sm-12">
                                          ...
                                          <div class="card">
                                                ...
                                                <div class="card-block">
                                                      <div class="sub-title">Registration Details Here</div>
                                                            <div class="row">
                                                                  <div class="col-sm-12 col-md-12 col-xl-6">
                                                                       <div class="card-block">
                                                                        <!-- main section starts here -->
                                                                         <table border="2" bgcolor="#00FCF0" class="table table-striped" style="font-family: cursive; text-align: center;">
                                                                              <tr align="center">
                                                                                    <td>Stusents Roll Number</td>
                                                                                    <td>Students Name</td>
                                                                                    <td>Students Age</td>
                                                                                    <td>Semester</td>
                                                                              </tr>
   ...
   <?php include_once("bottomScripts2.php")?>
