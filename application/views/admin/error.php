...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/error.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:39:52 GMT -->
<head>
...
<a href="<?=base_url('resources/admin/')?>/extra-pages/404/index.html" target="_blank"><img src="<?=base_url('resources/admin/')?>/assets/images/error/error-1.jpg" alt="Layout-1" class="img-fluid img-thumbnail"></a>
</div>
<div class="col-sm-3 m-b-30">
<a href="<?=base_url('resources/admin/')?>/extra-pages/404/1/index-bubble.html" target="_blank"><img src="<?=base_url('resources/admin/')?>/assets/images/error/error-2.jpg" alt="Layout-2" class="img-fluid img-thumbnail"></a>
</div>
<div class="col-sm-3 m-b-30">
<a href="<?=base_url('resources/admin/')?>/extra-pages/404/1/index-flat.html" target="_blank"><img src="<?=base_url('resources/admin/')?>/assets/images/error/error-3.jpg" alt="Layout-3" class="img-fluid img-thumbnail"></a>
</div>
<div class="col-sm-3 m-b-30">
<a href="<?=base_url('resources/admin/')?>/extra-pages/404/1/index-image.html" target="_blank"><img src="<?=base_url('resources/admin/')?>/assets/images/error/error-4.jpg" alt="Layout-4" class="img-fluid img-thumbnail"></a>
</div>
</div>
<div class="row">
<div class="col-sm-3 m-b-30">
<a href="<?=base_url('resources/admin/')?>/extra-pages/404/1/index-mozaic.html" target="_blank"><img src="<?=base_url('resources/admin/')?>/assets/images/error/error-5.jpg" alt="Layout-5" class="img-fluid img-thumbnail"></a>
</div>
<div class="col-sm-3">
<a href="<?=base_url('resources/admin/')?>/extra-pages/404/1/index-youtube.html" target="_blank"><img src="<?=base_url('resources/admin/')?>/assets/images/error/error-6.jpg" alt="Layout-5" class="img-fluid img-thumbnail"></a>
</div>
</div>
</div>
</div>
...
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/bower_components/classie/js/classie.html"></script>
...
<script src="<?=base_url('resources/admin/')?>/assets/js/jquery.mousewheel.min.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/js/script.js"></script>
</body>

<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/error.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:39:58 GMT -->
</html>
