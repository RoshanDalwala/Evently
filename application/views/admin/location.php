...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/location.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:39:45 GMT -->
<head>
...
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/pages/location/leaflet-mapbox-gl.js"></script>
...
<script>
    setTimeout(function(){
        ...
        var greenIcon = L.icon({
            iconUrl: '<?=base_url('resources/admin/')?>/assets/images/social/img1.jpg',
            shadowUrl: '<?=base_url('resources/admin/')?>/assets/images/social/profile.jpg',
        ...
        var LeafIcon = L.Icon.extend({
            options: {
                shadowUrl: '<?=base_url('resources/admin/')?>/assets/images/social/img1.jpg',
                iconSize: [38, 95],
                shadowSize: [50, 64],
                iconAnchor: [22, 94],
                shadowAnchor: [4, 62],
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/location.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:39:50 GMT -->
</html>
