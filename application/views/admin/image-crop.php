...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/image-crop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:40:06 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url("resources/admin/")?>/bower_components/cropper/css/cropper.css">

<link rel="stylesheet" type="text/css" href="<?=base_url("resources/admin/")?>/assets/icon/themify-icons/themify-icons.css">

<link href="<?=base_url("resources/admin/")?>/bower_components/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<img id="image" src="<?=base_url("resources/admin/")?>/assets/images/modal/overflow.jpg" alt="Crop Picture">
</div>
</div>
<div class="col-md-3">
...
<div class="image-cropper-container"><img src="<?=base_url("resources/admin/")?>/assets/images/modal/overflow.jpg" alt="" class="crop-basic img-fluid"></div>
</div>
</div>
</div>
</div>
...
<div class="image-cropper-container"><img src="<?=base_url("resources/admin/")?>/assets/images/modal/overflow.jpg" alt="" class="crop-modal img-fluid"></div>
</div>
</div>
</div>
</div>
...
<img src="<?=base_url("resources/admin/")?>/assets/images/modal/overflow.jpg" alt="" class="crop-not-movable img-fluid">
</div>
</div>
</div>
</div>
...
ratios, modal etc.</p>
<div class="image-cropper-container">
<img src="<?=base_url("resources/admin/")?>/assets/images/modal/overflow.jpg" alt="" class="crop-not-resizable img-fluid">
</div>
</div>
</div>
</div>
...
<div class="image-cropper-container"><img src="<?=base_url("resources/admin/")?>/assets/images/modal/overflow.jpg" alt="" class="crop-auto img-fluid"></div>
</div>
</div>
</div>
</div>
...
<div class="image-cropper-container"><img src="<?=base_url("resources/admin/")?>/assets/images/modal/overflow.jpg" alt="" class="crop-drag img-fluid"></div>
</div>
</div>
</div>
</div>
...
<div class="image-cropper-container"><img src="<?=base_url("resources/admin/")?>/assets/images/modal/overflow.jpg" alt="" class="crop-16-9 img-fluid"></div>
</div>
</div>
</div>
</div>
...
using <code>aspectRatio</code> option.</p>
<div class="image-cropper-container"><img src="<?=base_url("resources/admin/")?>/assets/images/modal/overflow.jpg" alt="" class="crop-4-3 img-fluid"></div>
</div>
</div>
</div>
</div>
...
<div class="image-cropper-container"><img src="<?=base_url("resources/admin/")?>/assets/images/modal/overflow.jpg" alt="" class="crop-min img-fluid"></div>
</div>
</div>
</div>
</div>
...
<div class="image-cropper-container"><img src="<?=base_url("resources/admin/")?>/assets/images/modal/overflow.jpg" alt="" class="crop-zoomable img-fluid"></div>
</div>
</div>
</div>
</div>
...
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/bower_components/switchery/js/switchery.min.js"></script>

<script src="<?=base_url("resources/admin/")?>/bower_components/cropper/js/cropper.js"></script>
<script src="<?=base_url("resources/admin/")?>/assets/pages/cropper/croper.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/image-crop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:40:09 GMT -->
</html>
