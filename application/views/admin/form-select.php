...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:38:07 GMT -->
<head>
...
<link rel="stylesheet" href="<?=base_url("resources/admin/")?>/bower_components/select2/css/select2.min.css" />

<link rel="stylesheet" type="text/css" href="<?=base_url("resources/admin/")?>/bower_components/bootstrap-multiselect/css/bootstrap-multiselect.css" />
<link rel="stylesheet" type="text/css" href="<?=base_url("resources/admin/")?>/bower_components/multiselect/css/multi-select.css" />
...
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/bower_components/select2/js/select2.full.min.js"></script>

<script type="text/javascript" src="<?=base_url("resources/admin/")?>/bower_components/bootstrap-multiselect/js/bootstrap-multiselect.js">
</script>
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/bower_components/multiselect/js/jquery.multi-select.js"></script>
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/assets/js/jquery.quicksearch.js"></script>

<script type="text/javascript" src="<?=base_url("resources/admin/")?>/assets/pages/advance-elements/select2-custom.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:38:10 GMT -->
</html>
