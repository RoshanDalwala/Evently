...
<div class="container">
	<div class="row">
		...
		<div class="section-headline margin-top-0 margin-bottom-20">
			<h3>Material icons</h3>
			<a class="headline-link bottom-icon" href="#feather-icons">Go to Next Icon Set</a>
		</div>
	...
	<div class="icon-set-container">
       <div class="glyph fs1">
		...
		<div class="col-md-12"  id="feather-icons">

			<div class="section-headline margin-top-90 margin-bottom-20">
				<h3>Feather icons</h3>
				<a class="headline-link bottom-icon" href="#line-awesome-icons">Go to Next Icon Set</a>
			</div>
		...
		<div class="col-md-12"  id="line-awesome-icons">

		<div class="section-headline margin-top-90 margin-bottom-20">
			<h3>Line Awesome Icons</h3>
			<a class="headline-link bottom-icon" href="#brand-icons">Go to Next Icon Set</a>
		</div>
	...
	<div class="icon-set-container">
		...
		<div class="col-md-12" id="brand-icons">
			<div class="section-headline margin-top-90 margin-bottom-20" >
				<h3>Brand Icons</h3>
			</div>
