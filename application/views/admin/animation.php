...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/animation.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:37:47 GMT -->
<head>
<title>Evently</title>
...
<img class="d-block img-fluid img-thumbnail" src="<?=base_url('resources/admin/')?>/assets/images/animate.jpg" alt="Third slide">
</div>
</div>
</div>
</div>
...
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/js/animation.js"></script>
