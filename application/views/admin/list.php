...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:36:48 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/pages/list-scroll/list.css">
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/bower_components/stroll/css/stroll.css">
...
<div class="media">
<a class="media-left" href="#">
<img class="media-object card-list-img" src="<?=base_url('resources/admin/')?>/assets/images/avatar-2.jpg" alt="Generic placeholder image">
</a>
<div class="media-body">
<div class="col-xs-12">
...
<div class="media">
<a class="media-left" href="#">
<img class="media-object card-list-img" src="<?=base_url('resources/admin/')?>/assets/images/avatar-3.jpg" alt="Generic placeholder image">
</a>
<div class="media-body">
<div>
<h6 class="d-inline-block">
...
<li>
<img src="<?=base_url('resources/admin/')?>/assets/images/avatar-2.jpg" class="img-fluid p-absolute d-block text-center" alt="">
<h6>Heading</h6>
<p>Laborum nihil aliquam nulla praesentium illo libero
nihil at odio maxime.</p>
</li>
...
<li>
<h6>Heading</h6>
<img src="<?=base_url('resources/admin/')?>/assets/images/avatar-3.jpg" class="img-fluid p-absolute d-block text-center" alt="">
<p>Laborum nihil aliquam nulla praesentium illo libero
nihil at odio maxime.</p>
</li>
</ul>
...
<script src="<?=base_url('resources/admin/')?>/bower_components/stroll/js/stroll.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/pages/list-scroll/list-custom.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:36:50 GMT -->
</html>
