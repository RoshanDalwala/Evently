...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-ext-autofill.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:38:22 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/autofill/css/autoFill.dataTables.min.css">
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/autofill/css/select.dataTables.min.css">
...
<script src="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/autofill/js/dataTables.autoFill.min.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/autofill/js/dataTables.select.min.js"></script>
...
<script src="<?=base_url('resources/admin/')?>/assets/pages/data-table/extensions/autofill/js/extensions-custom.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-ext-autofill.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:38:24 GMT -->
</html>
