...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/notification.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:37:00 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/pages/notification/notification.css">

<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/bower_components/animate.css/css/animate.css">
...
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/js/bootstrap-growl.min.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/pages/notification/notification.js"></script>
