...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/widget-chart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:36:06 GMT -->
<head>
...
<link rel="stylesheet" href="<?=base_url("resources/admin/")?>/assets/pages/chart/radial/css/radial.css" type="text/css" media="all">
...
<img src="<?=base_url("resources/admin/")?>/assets/images/avatar-2.jpg" alt="User-Image">
</div>
<div class="row">
<div class="col-6">
...
<div class="card-block text-center">
<div data-label="40%" class="radial-bar radial-bar-40 radial-bar-lg radial-bar-danger">
<img src="<?=base_url("resources/admin/")?>/assets/images/widget/sale-img.jpg" alt="User-Image">
</div>
<div class="row">
<div class="col-6">
...
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/assets/pages/widget/excanvas.js"></script>
...
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/bower_components/chart.js/js/Chart.js"></script>

<script type="text/javascript" src="<?=base_url("resources/admin/")?>/assets/js/SmoothScroll.js"></script>

<script src="<?=base_url("resources/admin/")?>/assets/pages/chart/knob/jquery.knob.js"></script>

<script type="text/javascript" src="<?=base_url("resources/admin/")?>/assets/pages/chart/knob/knob-custom-chart.js"></script>

<script src="<?=base_url("resources/admin/")?>/assets/pages/widget/amchart/amcharts.js"></script>
<script src="<?=base_url("resources/admin/")?>/assets/pages/widget/amchart/gauge.js"></script>
...
<script src="<?=base_url("resources/admin/")?>/assets/pages/widget/amchart/pie.min.js"></script>
<script src="<?=base_url("resources/admin/")?>/assets/pages/widget/amchart/ammap.min.js"></script>
<script src="<?=base_url("resources/admin/")?>/assets/pages/widget/amchart/usaLow.js"></script>
...
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/assets/pages/widget/widget-chart.js"></script>
<script type="text/javascript" src="<?=base_url("resources/admin/")?>/assets/js/script.js"></script>
</body>

<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/widget-chart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:36:08 GMT -->
</html>
