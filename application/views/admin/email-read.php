...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/email-read.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:40:01 GMT -->
<head>
...
<a href="#">
<img class="media-object img-radius" src="<?=base_url('resources/admin/')?>/assets/images/avatar-3.jpg" alt="E-mail User">
</a>
</div>
...
<h6>From:<span class="__cf_email__" data-cfemail="e2888d8a8c868d87d3d7d6d1a2858f838b8ecc818d8f">[email&#160;protected]</span></h6>
</a>
<div>
...
<a href="#"><img class="card-img-top img-fluid img-thumbnail" src="<?=base_url('resources/admin/')?>/assets/images/card-block/card1.jpg" alt="Card image cap"></a>
</div>
<div class="col-sm-4 col-md-2 col-xs-12">
<a href="#"><img class="card-img-top img-fluid img-thumbnail" src="<?=base_url('resources/admin/')?>/assets/images/card-block/card2.jpg" alt="Card image cap"></a>
</div>
<div class="col-sm-4 col-md-2 col-xs-12">
<a href="#"><img class="card-img-top img-fluid img-thumbnail" src="<?=base_url('resources/admin/')?>/assets/images/card-block/card13.jpg" alt="Card image cap"></a>
</div>
</div>
<form class="form-material">
