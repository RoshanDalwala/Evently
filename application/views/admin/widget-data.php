...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/widget-data.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:36:03 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/css/font-awesome-n.min.css">

<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/css/style.css">
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/css/widget.css">
</head>
<body>
...
<img src="<?=base_url('resources/admin/')?>/assets/images/avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
...
<div class="align-middle m-b-25">
<img src="<?=base_url('resources/admin/')?>/assets/images/avatar-3.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
<div class="d-inline-block">
...
<div class="align-middle m-b-25">
<img src="<?=base_url('resources/admin/')?>/assets/images/avatar-4.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
<div class="d-inline-block">
<a href="#!"><h6>John Doue</h6></a>
<p class="text-muted m-b-0">Cheers!</p>
...
<tr>
<td>HeadPhone</td>
<td><img src="<?=base_url('resources/admin/')?>/assets/images/widget/p1.jpg" alt="" class="img-fluid img-20"></td>
<td>
...
<tr>
<td>Iphone 6</td>
<td><img src="<?=base_url('resources/admin/')?>/assets/images/widget/p2.jpg" alt="" class="img-fluid img-20"></td>
<td>
<div class="p-status bg-c-green"></div>
</td>
<td>$20</td>
...
<tr>
<td>Jacket</td>
<td><img src="<?=base_url('resources/admin/')?>/assets/images/widget/p3.jpg" alt="" class="img-fluid img-20"></td>
<td>
<div class="p-status bg-c-green"></div>
</td>
<td>$35</td>
...
<tr>
<td>Sofa</td>
<td><img src="<?=base_url('resources/admin/')?>/assets/images/widget/p4.jpg" alt="" class="img-fluid img-20"></td>
<td>
<div class="p-status bg-c-green"></div>
</td>
<td>$85</td>
...
<img src="<?=base_url('resources/admin/')?>/assets/images/avatar-4.jpg" alt="user image" class="img-radius img-40 align-top m-r-15 update-icon">
</div>
<div class="col p-l-5">
...
<img src="<?=base_url('resources/admin/')?>/assets/images/avatar-2.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
</div>
<div class="col">
...
<div class="row">
<div class="col-sm-auto p-r-0">
 <img src="<?=base_url('resources/admin/')?>/assets/images/avatar-1.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
</div>
<div class="col">
<h6 class="m-b-15">John Deo</h6>
<div class="row align-items-center">
...
<td>Sofa</td>
<td>#PHD001</td>
<td><a href="https://demo.dashboardpack.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="29484b4a694e44484045074a4644">[email&#160;protected]</a></td>
...
<td>Computer</td>
<td>#PHD002</td>
<td><a href="https://demo.dashboardpack.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="caa9aea98aada7aba3a6e4a9a5a7">[email&#160;protected]</a></td>
...
<td>Mobile</td>
<td>#PHD003</td>
<td><a href="https://demo.dashboardpack.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ea9a9b98aa8d878b8386c4898587">[email&#160;protected]</a></td>
<td><label class="label label-danger">Out Stock</label></td>
<td>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<td>Coat</td>
<td>#PHD004</td>
<td><a href="https://demo.dashboardpack.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c7a5a4b487a0aaa6aeabe9a4a8aa">[email&#160;protected]</a></td>
<td><label class="label label-success">In Stock</label></td>
<td>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<td>Shoes</td>
<td>#PHD006</td>
<td><a href="https://demo.dashboardpack.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="dbabaaa99bbcb6bab2b7f5b8b4b6">[email&#160;protected]</a></td>
<td><label class="label label-danger">Out Stock</label></td>
<td>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<li class="d-inline-block"><img src="<?=base_url('resources/admin/')?>/assets/images/avatar-2.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
<li class="d-inline-block"><img src="<?=base_url('resources/admin/')?>/assets/images/avatar-3.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
<li class="d-inline-block"><img src="<?=base_url('resources/admin/')?>/assets/images/avatar-2.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
</ul>
...
<ul class="list-unstyled m-b-20">
<li class="d-inline-block"><img src="<?=base_url('resources/admin/')?>/assets/images/avatar-4.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
<li class="d-inline-block"><img src="<?=base_url('resources/admin/')?>/assets/images/avatar-2.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
<li class="d-inline-block"><img src="<?=base_url('resources/admin/')?>/assets/images/avatar-3.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
</ul>
<p class="m-b-10">New Dashboard <span class="float-right text-muted f-14">5 Mins ago</span></p>
...
<div class="col-auto p-r-0">
<img src="<?=base_url('resources/admin/')?>/assets/images/avatar-2.jpg" alt="user image" class="img-radius img-40">
</div>
<div class="col">
<div class="msg">
...
<img src="<?=base_url('resources/admin/')?>/assets/images/avatar-3.jpg" alt="user image" class="img-radius img-40">
</div>
</div>
<div class="row m-b-20 received-chat">
<div class="col-auto p-r-0">
...
<div class="msg">
<p class="m-b-0">Nice to meet you!</p>
<img src="<?=base_url('resources/admin/')?>/assets/images/mega-menu/01.jpg" alt="">
<img src="<?=base_url('resources/admin/')?>/assets/images/mega-menu/03.jpg" alt="">
</div>
<p class="text-muted m-b-0"><i class="fa fa-clock-o m-r-10"></i>10:20am</p>
</div>
</div>
...
<script src="<?=base_url('resources/admin/')?>/assets/pages/chart/float/jquery.flot.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/chart/float/jquery.flot.categories.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/chart/float/curvedLines.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/chart/float/jquery.flot.tooltip.min.js"></script>

<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/pages/todo/todo.js"></script>

<script src="./././developers.google.com/maps/documentation/javascript/examples/markerclusterer/markerclusterer.js"></script>
<script type="text/javascript" src="https://maps.google.com/maps/api/js?sensor=true"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/pages/google-maps/gmaps.js"></script>
...
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/pages/widget/widget-data.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/js/script.min.js"></script>
</body>

<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/widget-data.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:36:05 GMT -->
</html>
