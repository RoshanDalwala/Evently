...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/generic-class.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:36:14 GMT -->
<head>
...
<img src="<?=base_url("resources/admin/")?>/assets/images/avatar-4.jpg" class="img-20" alt="user.png">
</li>
<li>
<code data-toggle="tooltip" data-placement="top" title="Realtive">.img-30</code>
<img src="<?=base_url("resources/admin/")?>/assets/images/avatar-4.jpg" class="img-30" alt="user.png">
</li>
<li>
<code data-toggle="tooltip" data-placement="top" title="Realtive">.img-40</code>
<img src="<?=base_url("resources/admin/")?>/assets/images/avatar-4.jpg" class="img-40" alt="user.png">
</li>
<li>
<code data-toggle="tooltip" data-placement="top" title="Realtive">.img-50</code>
<img src="<?=base_url("resources/admin/")?>/assets/images/avatar-4.jpg" class="img-50" alt="user.png">
</li>
<li>
<code data-toggle="tooltip" data-placement="top" title="Realtive">.img-60</code>
<img src="<?=base_url("resources/admin/")?>/assets/images/avatar-4.jpg" class="img-60" alt="user.png">
</li>
<li>
<code data-toggle="tooltip" data-placement="top" title="Realtive">.img-70</code>
<img src="<?=base_url("resources/admin/")?>/assets/images/avatar-4.jpg" class="img-70" alt="user.png">
</li>
<li>
<code data-toggle="tooltip" data-placement="top" title="Realtive">.img-80</code>
<img src="<?=base_url("resources/admin/")?>/assets/images/avatar-4.jpg" class="img-80" alt="user.png">
</li>
<li>
<code data-toggle="tooltip" data-placement="top" title="Realtive">.img-90</code>
<img src="<?=base_url("resources/admin/")?>/assets/images/avatar-4.jpg" class="img-90" alt="user.png">
</li>
<li>
<code data-toggle="tooltip" data-placement="top" title="Realtive">.img-100</code>
<img src="<?=base_url("resources/admin/")?>/assets/images/avatar-4.jpg" class="img-100" alt="user.png">
</li>
</ul>
</div>
</div>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/generic-class.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:36:48 GMT -->
</html>
