...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/map-vector.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:39:37 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/css/jquery-jvectormap-2.0.2.css">
...
<script src="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/js/jquery-jvectormap-2.0.2.min.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/js/jquery-jvectormap-world-mill-en.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/js/gdp-data.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/js/jquery-jvectormap-us-aea-en.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/js/jquery-jvectormap-uk-mill-en.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/js/jquery-jvectormap-au-mill.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/js/jquery-jvectormap-us-il-chicago-mill-en.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/js/jquery-jvectormap-ca-lcc.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/js/jquery-jvectormap-de-mill.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/js/jquery-jvectormap-in-mill.js"></script>
<script src="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/js/jquery-jvectormap-asia-mill.js"></script>

<script src="<?=base_url('resources/admin/')?>/assets/pages/vector-maps/js/map-vector.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/map-vector.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:39:44 GMT -->
</html>
