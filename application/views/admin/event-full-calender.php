...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/event-full-calender.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:40:02 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/bower_components/fullcalendar/css/fullcalendar.css">
<link rel="stylesheet" type="text/css" href="<?=base_url('resources/admin/')?>/bower_components/fullcalendar/css/fullcalendar.print.css" media='print'>
...
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/js/classie.js"></script>

<script type="text/javascript" src="<?=base_url('resources/admin/')?>/bower_components/moment/js/moment.min.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/bower_components/fullcalendar/js/fullcalendar.min.js"></script>

<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/pages/full-calender/calendar.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/event-full-calender.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:40:04 GMT -->
</html>
