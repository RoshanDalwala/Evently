                                                ...
                                                <div class="freelancer-name">
                                                    ...
                                                    <div class="freelancer-rating">
                                                        <?php
                                                            ...
                                                            {
                                                            ?>
                                                                <span class="btn btn-warning" style="background-color:orange;color: white;padding:7px;border-radius: 5px;">Assigned</span>
                                                            <?php
                                                            }
                                                            else if($p->status==0)
                                                            {
                                                            ?>
                                                                <span class="btn btn-primary" style="background-color:green;color: white;padding:7px;border-radius: 5px;">Pending</span>
                                                    ...
                                                    <ul class="dashboard-task-info bid-info">
                                                        <li><strong><?=$p->Budget?></strong><span>Project Budget</span></li>
                                                        <li><strong><?=$p->Price?></strong><span>Bid Price</span></li>
                                                        <li><a href="<?=site_url('user/ProjectC/disProjectDetails/'.$p->ProjectID)?>"><strong>Go To Project</strong></li></a>
