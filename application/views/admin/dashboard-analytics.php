...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dashboard-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:35:35 GMT -->
<head>
...
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/pages/dashboard/analytic-dashboard.min.js"></script>
<script type="text/javascript" src="<?=base_url('resources/admin/')?>/assets/js/script.min.js"></script>
</body>

<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dashboard-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:35:38 GMT -->
</html>
