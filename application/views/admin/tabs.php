...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/tabs.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 13:36:48 GMT -->
<head>
...
<img src="<?=base_url('resources/admin/')?>/assets/images/avatar-2.jpg" class="img-fluid img-circle" alt="">
...
<img src="<?=base_url('resources/admin/')?>/assets/images/avatar-3.jpg" class="img-fluid img-circle" alt="">
<span class="quote"><i class="icofont icofont-quote-left bg-primary"></i></span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" data-toggle="tab" href="#settings8" role="tab">
<img src="<?=base_url('resources/admin/')?>/assets/images/avatar-4.jpg" class="img-fluid img-circle" alt="">
<span class="quote"><i class="icofont icofont-quote-left bg-primary"></i></span>
</a>
</li>
</ul>
