		...
		<div class="col-xl-5 offset-xl-3">
			...
			<div class="login-register-page">
				...
				<div class="welcome-text">
					...
					<span>Already have an account?<a href="<?=site_url('user/UserC/login')?>">Log In!</a></span>
				</div>
					
				<!-- Form -->
				<form method="post" enctype="multipart/form-data" action="<?=site_url('User/UserC/insertSignup')?>"> 
                    ...
                    <div class="input-with-icon-left">Description
						<input type="text" class="input-text with-border" name="txtDescription" id="description" placeholder="Description" required/>
					</div>
